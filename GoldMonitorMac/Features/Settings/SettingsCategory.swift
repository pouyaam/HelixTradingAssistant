...
enum SettingsCategory: String, CaseIterable, Identifiable {
    case general, notifications, data, ai, mcp, network, autoTrader, about
    ...
    var symbol: String {
        ...
        case .mcp:        return "point.3.filled.connected.trianglepath.dotted"
    ...
    var blurb: String {
        ...
        case .mcp:        return "Serve this app's market data and SMC engines to other AI tools over MCP. Local, read-only."
